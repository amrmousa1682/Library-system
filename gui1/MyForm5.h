...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->exsit->Location = System::Drawing::Point(17, 82);
			...
			this->exsit->Click += gcnew System::EventHandler(this, &MyForm5::exsit_Click);
			// 
			// button1
			// 
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(269, 82);
			...
			this->label1->Text = L"Borrow  a book";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(157, 51);
			...
			this->ClientSize = System::Drawing::Size(358, 122);
