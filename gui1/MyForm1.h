...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label4->Text = L"Number of copies";
			// 
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(162, 108);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(174, 20);
			this->textBox1->TabIndex = 4;
			this->textBox1->TextChanged += gcnew System::EventHandler(this, &MyForm1::textBox2_TextChanged);
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(162, 58);
			...
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(162, 158);
			...
			this->button1->Location = System::Drawing::Point(261, 193);
			...
			this->exsit->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->exsit->Location = System::Drawing::Point(26, 205);
			...
			this->exsit->Click += gcnew System::EventHandler(this, &MyForm1::exsit_Click);
			// 
			// MyForm1
			// 
			...
			this->ClientSize = System::Drawing::Size(353, 254);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) 
	{
		...
		file.WriteLine("name:"+textBox2->Text + " ,ID:" + textBox1->Text + " ,number of copies:" + textBox3->Text);
		file.Close();
		this->Close();
	}
